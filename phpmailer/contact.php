...
$mail = new PHPMailer(true);
	...
	$mail->SMTPDebug = 0;
	$mail->isSMTP();
	$mail->Host       = 'mail.grupogestionagt.com';
	$mail->SMTPAuth   = true;
	$mail->Username   = 'contacto@grupogestionagt.com';
	$mail->Password   = 'Grupogestiona2020';
	$mail->SMTPSecure = 'SMTP';
	$mail->Port       =  26;

	$mail->setFrom('contacto@grupogestionagt.com', 'GRUPO GESTIONA');
	$subject  = $subject_;
	$address  = $address_;
